...
public class MecanumStrafeRightForDistance extends CommandBase {
  ...
  public MecanumStrafeRightForDistance(DoubleSupplier leftY,
    ...
    this.chopperDrive = chopperDrive;
        ...
        mLog.debug(this.getClass().getName() + ":StrafeRightforDistance:" + leftY.getAsDouble() + ":" +leftX.getAsDouble());
  }
  ...
  public void initialize() {
    ...
    mLog.debug(this.getClass().getName() + ":starting strafe right");
