...
public class MecanumDriveBackForDistance extends CommandBase {
  ...
  public MecanumDriveBackForDistance(DoubleSupplier leftY,
        ...
        mLog.debug( this.getClass().getName() + ":constructor:" + leftY.getAsDouble() + ":" +leftX.getAsDouble());
    }
  ...
  public void initialize() {
    ...
    mLog.debug(this.getClass().getName() + ":starting drive back, resetting encoder");
  ...
  public void end(boolean interrupted) {
    ...
    chopperDrive.stop();
    mLog.debug(this.getClass().getName() + ":stop motors");
  }
